...
import { CoolModeContext, provideCoolModeContext } from './CoolModeContext';
import { I18nProvider, provideI18nContext } from './I18nContext';
import { ModalProvider, provideModalContext } from './ModalContext';
import {
  ModalSizeOptions,
  ModalSizeProvider,
  type ModalSizes,
  provideModalSizeContext,
} from './ModalSizeContext';
import { RainbowKitChainProvider, provideRainbowKitChainContext } from './RainbowKitChainContext';
import { ShowBalanceProvider, provideShowBalanceContext } from './ShowBalanceContext';
import { ShowRecentTransactionsContext, provideShowRecentTransactionsContext } from './ShowRecentTransactionsContext';
...
export function provideRainbowKitProvider({
  appInfo = {},
  ...
  provideRainbowKitChainContext({ chains, initialChain });
  provideAppContext(appInfo);
  provideAvatarContext(avatar);
  provideCoolModeContext(coolMode);
  provideModalSizeContext(modalSize);
  provideShowRecentTransactionsContext(showRecentTransactions);
  provideShowBalanceContext();
  provideI18nContext(locale);
  provideModalContext();
  // TODO: Add theme logic, fingerprint, preload images, etc.
}
